...
function createSlide(poster, year, title, imdbID, imdbRating) {
  var slide =
    ...
    '<img class="poster card-img-top" src="' +
    poster +
    '" alt="' +
    title +
    '" onerror="this.onerror=null; this.src="http://dummyimage.com/300x400/99cccc.gif&text=No+poster";" /></div>' +
    '<div class="footer-card">' +
    '<a href="https://www.imdb.com/title/' +
    imdbID +
    '/" class="link-card"><p class="title">' +
    title +
    "</p></a>" +
    ...
    ' <span class="MDb"><a class="film-rating">IMDb:' +
    imdbRating +
    "</a></span>" +
    "</div>" +
    " </div>" +
...
function generateDropDownYears() {
  ...
  globalConstants.yearSelector.addEventListener("click", function () {
    ...
    variables.queryYear =
      globalConstants.yearSelector.options[
        globalConstants.yearSelector.selectedIndex
      ].text;
  });
}
module.exports = {
