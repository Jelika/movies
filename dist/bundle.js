...
/*!**************************!*\
  ...
  \**************************/
/*! namespace exports */
/*! export globalConstants [provided] [no usage info] [missing usage info prevents renaming] */
...
var globalConstants = {
  ...
  filmListSwiper: new swiper__WEBPACK_IMPORTED_MODULE_0__.default(".swiper-container", {
    slidesPerView: 1,
    spaceBetween: 10,
...
function addListeners() {
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.formComponent.addEventListener("submit", function (event) {
    event.preventDefault();
    (0,_functionality__WEBPACK_IMPORTED_MODULE_1__.searchClick)();
  });
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.closeButton.addEventListener("click", function () {
    _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.inputField.value = "";
    _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.closeButton.classList.add("d-none");
  });
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.inputField.addEventListener("keyup", function () {
    if (_constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.inputField.value) {
      _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.closeButton.classList.remove("d-none");
    } else {
      _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.closeButton.classList.add("d-none");
    }
  });
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper.on("init", function () {
    _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper.slideTo(0);
  });
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper.on("slideChange", function () {
    var regexLangRus = /(^[А-я0-9\s]+)(?!.*[A-z])/;
    var preloadFilms = _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper.activeIndex % 6 === 0;

    if (preloadFilms && _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper.activeIndex != 0) {
      var keyWord = document.querySelector("#input").value;
      _constants__WEBPACK_IMPORTED_MODULE_0__.variables.pageNumber += 1;

      if (regexLangRus.exec(keyWord)) {
        (0,_functionality__WEBPACK_IMPORTED_MODULE_1__.getTranslateWord)(keyWord, _constants__WEBPACK_IMPORTED_MODULE_0__.variables.pageNumber);
      } else {
        (0,_functionality__WEBPACK_IMPORTED_MODULE_1__.getMovieInfo)(keyWord, _constants__WEBPACK_IMPORTED_MODULE_0__.variables.pageNumber);
      }
    }
  });
}
...
/*!******************************!*\
  ...
  \******************************/
/*! namespace exports */
/*! export getMovieInfo [provided] [no usage info] [missing usage info prevents renaming] */
/*! export getTranslateWord [provided] [no usage info] [missing usage info prevents renaming] */
/*! export searchClick [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__, __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getTranslateWord": () => /* binding */ getTranslateWord,
/* harmony export */   "getMovieInfo": () => /* binding */ getMovieInfo,
/* harmony export */   "searchClick": () => /* binding */ searchClick
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/constants.js");
/* harmony import */ var _view_creation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view-creation */ "./src/view-creation.js");



var infoContainer = _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.infoContainer,
    spinner = _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.spinner,
    inputField = _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.inputField,
    filmListSwiper = _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper; //let { pageNumber, queryYear } = variables;

function getTranslateWord(word, page, shouldTranslate) {
  var url = "https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20200505T162523Z.33ff202967427e1b.2d537f5864213fe73f92105d302ab7486efc9940&text=".concat(word, "&lang=ru-en");
  fetch(url).then(function (response) {
    ...
    infoContainer.innerText = "Showing results for ".concat(word);
  });
}
function getMovieInfo(keyWord, page, shouldTranslate) {
  var url = "https://www.omdbapi.com/?s=".concat(keyWord, "&page=").concat(page, "&y=").concat(_constants__WEBPACK_IMPORTED_MODULE_0__.variables.queryYear, "&apikey=e1ab60a9");
  ...
  fetch(url).then(function (response) {
    ...
    if (date.Response === "True") {
      ...
      date.Search.forEach(function (element) {
        ...
        var urlRating = "https://www.omdbapi.com/?i=".concat(imdbID, "&apikey=e1ab60a9");
        fetch(urlRating).then(function (result) {
          return result.json();
        }).then(function (res) {
          var imdbRating = res.imdbRating;
          (0,_view_creation__WEBPACK_IMPORTED_MODULE_1__.createSlide)(poster, year, title, imdbID, imdbRating);
        });
      });
    } else {
      spinner.classList.add("d-none");
      console.log("Error: ".concat(date.Error));
      infoContainer.innerText = "".concat(date.Error);
    }
  });
}
function searchClick() {
  ...
  if (keyWord !== "") {
    if (regexLang.exec(keyWord)) {
      ...
      if (regexLangRus.exec(keyWord)) {
        getTranslateWord(keyWord, _constants__WEBPACK_IMPORTED_MODULE_0__.variables.pageNumber, true);
      } else {
        getMovieInfo(keyWord, _constants__WEBPACK_IMPORTED_MODULE_0__.variables.pageNumber, true);
        infoContainer.innerText = "Showing results for '".concat(keyWord, "'");
      }

      filmListSwiper.slideTo(0);
    } else infoContainer.innerText = "No results for ".concat(keyWord);
  }
}
...
/* harmony import */ var _view_creation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view-creation */ "./src/view-creation.js");
/* harmony import */ var _events_creation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./events-creation */ "./src/events-creation.js");
...
window.onload = function () {
  (0,_functionality__WEBPACK_IMPORTED_MODULE_2__.getMovieInfo)("home", 1);
  (0,_view_creation__WEBPACK_IMPORTED_MODULE_3__.generateDropDownYears)();
  (0,_events_creation__WEBPACK_IMPORTED_MODULE_4__.addListeners)();
};

/***/ }),

/***/ "./src/view-creation.js":
/*!******************************!*\
  !*** ./src/view-creation.js ***!
  \******************************/
/*! namespace exports */
/*! export createSlide [provided] [no usage info] [missing usage info prevents renaming] */
/*! export generateDropDownYears [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
/*! runtime requirements: __webpack_require__, __webpack_require__.r, __webpack_exports__, __webpack_require__.d, __webpack_require__.* */
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "generateDropDownYears": () => /* binding */ generateDropDownYears
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/constants.js");


function createSlide(poster, year, title, imdbID, imdbRating) {
  var slide = "\n              <div class=\"swiper-slide\" style=\"width: 492px; margin-right: 30px;\">\n                  <div class=\"card\">\n                      <div class=\"slide=main\">\n                          <img class=\"poster card-img-top\" src=\"".concat(poster, "\" alt=\"").concat(title, "\" onerror=\"this.onerror=null; this.src='http://dummyimage.com/300x400/99cccc.gif&text=No+poster';\" /></div>\n                          <div class=\"footer-card\">\n                              <a href=\"https://www.imdb.com/title/").concat(imdbID, "/\" class=\"link-card\"><p class=\"title\">").concat(title, "</p></a>\n                              <div class=\"movie-info\">\n                                  <span class=\"year\">").concat(year, "</span>\n                                  <img class=\"film-star\" src=\"assets/img/star.png\" >\n                                  <span class=\"MDb\"><a class=\"film-rating\">IMDb:").concat(imdbRating, "</a></span>\n                              </div>\n                          </div>\n                  </div>\n              </div>");
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper.appendSlide(slide);
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.filmListSwiper.update();
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.spinner.classList.add("d-none");
}
function generateDropDownYears() {
  ...
  _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.yearSelector.addEventListener("click", function () {
    // eslint-disable-next-line
    _constants__WEBPACK_IMPORTED_MODULE_0__.variables.queryYear = _constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.yearSelector.options[_constants__WEBPACK_IMPORTED_MODULE_0__.globalConstants.yearSelector.selectedIndex].text;
    console.log('год', _constants__WEBPACK_IMPORTED_MODULE_0__.variables.queryYear);
  });
}
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "footer,\r\nheader {\r\n  background-color: rgba(62, 134, 163, 0.6);\r\n  text-align: center;\r\n  min-height: 10vh;\r\n  border-bottom: 3px solid rgba(62, 134, 163, 1);\r\n}\r\nfooter {\r\n  border-top: 3px solid rgba(62, 134, 163, 1);\r\n  display: flex;\r\n  align-items: center;\r\n}\r\n\r\n* {\r\n  box-sizing: border-box;\r\n  margin: 0 auto;\r\n}\r\n\r\n.wrapper-form {\r\n  max-width: 1440px;\r\n  margin-left: 50px;\r\n}\r\n\r\n.wrapper-slider {\r\n  max-width: 1440px;\r\n  margin: 0 auto;\r\n  margin-top: 50px;\r\n  margin-bottom: 50px;\r\n}\r\n\r\n.logo {\r\n  font-size: 2rem;\r\n}\r\n\r\n.navbar-brand {\r\n  display: inline-flex;\r\n  font-family: \"Poppins\", sans-serif;\r\n  line-height: inherit;\r\n  padding: 30px;\r\n  white-space: nowrap;\r\n}\r\n\r\n.nav-bar__logo__img {\r\n  width: 60px;\r\n  margin-bottom: 15px;\r\n  margin-left: -30px;\r\n  height: 60px;\r\n}\r\n\r\nh1.text-info {\r\n  color: #fff !important;\r\n}\r\n\r\n.close {\r\n  position: relative;\r\n  right: 130px;\r\n  bottom: 15px;\r\n}\r\n\r\n.close:hover {\r\n  opacity: 1;\r\n}\r\n\r\n.close:before,\r\n.close:after {\r\n  position: absolute;\r\n  left: 15px;\r\n  content: \" \";\r\n  height: 33px;\r\n  width: 2px;\r\n  background-color: #333;\r\n}\r\n\r\n.close:before {\r\n  transform: rotate(45deg);\r\n}\r\n\r\n.close:after {\r\n  transform: rotate(-45deg);\r\n}\r\n\r\n.form-group {\r\n  position: relative;\r\n  margin-bottom: 10px;\r\n  margin-top: 10px;\r\n}\r\n\r\n.form-row {\r\n  display: -webkit-box;\r\n  display: flex;\r\n  -webkit-box-pack: justify;\r\n  justify-content: space-between;\r\n  -webkit-box-align: center;\r\n  align-items: center;\r\n  flex-wrap: wrap;\r\n  margin-right: 0;\r\n}\r\n.form-control:focus {\r\n  box-shadow: none;\r\n  border-color: rgb(145, 145, 145);\r\n}\r\n.search-input {\r\n  display: block;\r\n  width: calc(100% - 150px);\r\n  max-width: 1350px;\r\n  padding-right: 100px;\r\n}\r\ninput[type=\"text\"] {\r\n  font-family: \"Poppins\", sans-serif;\r\n  font-size: 17px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n.search-input::placeholder {\r\n  font-family: \"Poppins\", sans-serif;\r\n  font-size: 17px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n\r\nbutton,\r\ninput {\r\n  overflow: visible;\r\n}\r\n\r\nbutton,\r\ninput,\r\noptgroup,\r\nselect,\r\ntextarea {\r\n  margin: 0;\r\n  font-family: inherit;\r\n  font-size: inherit;\r\n  line-height: inherit;\r\n}\r\n\r\n#submit-bottom {\r\n  position: absolute;\r\n  right: 60px;\r\n  font-family: \"Poppins\", sans-serif;\r\n  background-color: rgba(62, 134, 163, 1);\r\n  color: #fff;\r\n  padding: 10px;\r\n  font-size: 17px;\r\n}\r\n\r\n.spinner-border {\r\n  display: inline-block;\r\n  width: 2rem;\r\n  height: 2rem;\r\n  vertical-align: text-bottom;\r\n  border: 0.25em solid;\r\n  border-right: 0.25em solid transparent;\r\n  border-radius: 50%;\r\n  -webkit-animation: spinner-border 0.75s linear infinite;\r\n  animation: spinner-border 0.75s linear infinite;\r\n}\r\n\r\n.d-none {\r\n  display: none !important;\r\n}\r\n\r\n.spinner-border {\r\n  position: absolute;\r\n  right: 240px;\r\n}\r\n\r\nbutton,\r\nselect {\r\n  text-transform: none;\r\n  outline: none !important;\r\n}\r\n\r\n.info {\r\n  padding-bottom: 50px;\r\n  margin: 0 auto;\r\n  max-width: 340px;\r\n  /* margin-left: -50px; */\r\n  text-align: center;\r\n  padding-left: 20px;\r\n  padding-right: 20px;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  font-size: 1rem;\r\n  height: 2rem;\r\n  font-family: \"Poppins\", sans-serif;\r\n  line-height: inherit;\r\n  color: rgb(145, 145, 145) !important;\r\n}\r\n\r\n@media (min-width: 1441px) {\r\n  .wrapper-form {\r\n    margin: 0 auto;\r\n  }\r\n}\r\n\r\n@media (max-width: 576px) {\r\n  #submit-bottom,\r\n  .clear-input-btn,\r\n  .nav-bar__logo__img,\r\n  .wrapper {\r\n    display: none;\r\n  }\r\n  .form-row {\r\n    justify-content: center;\r\n    padding-right: 10px;\r\n  }\r\n  .search-input {\r\n    padding-left: 50px;\r\n    padding-right: 20px;\r\n    width: 95%;\r\n  }\r\n  .speak-btn {\r\n    margin-top: 0.5rem;\r\n  }\r\n  .spinner-border {\r\n    top: 5px;\r\n    right: 40px;\r\n  }\r\n}\r\n\r\na.footer-link {\r\n  -webkit-transition-duration: 0.5s;\r\n  transition-duration: 0.5s;\r\n  display: flex;\r\n}\r\n\r\na {\r\n  text-decoration: none;\r\n  background-color: transparent;\r\n}\r\n\r\n.github-logo {\r\n  margin-top: 5px;\r\n  margin-right: -7px;\r\n  width: 20px;\r\n  height: 20px;\r\n}\r\n\r\nh5,\r\n.github,\r\n.year,\r\n.MDb {\r\n  font-size: 1rem;\r\n  position: relative;\r\n  margin: 0;\r\n  padding-top: 5px;\r\n  padding-left: 10px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n\r\n.title:hover {\r\n  color: rgb(195, 240, 247) !important;\r\n}\r\n\r\n.MDb {\r\n  left: 80px;\r\n  bottom: 3px;\r\n}\r\n\r\n.year {\r\n  left: 35px;\r\n  bottom: 3px;\r\n}\r\n\r\n:root {\r\n  --swiper-theme-color: rgb(145, 145, 145) !important;\r\n}\r\n\r\n.film-star {\r\n  position: relative;\r\n  width: 20px;\r\n  height: 20px;\r\n  bottom: 5px;\r\n  left: 90px;\r\n}\r\n\r\n.film-rating,\r\n.year,\r\n.title {\r\n  font-size: 20px;\r\n  font-weight: 650;\r\n}\r\n\r\n.text-muted {\r\n  color: #fff !important;\r\n}\r\n\r\n.slider {\r\n  position: relative;\r\n  max-width: 1440px;\r\n  margin: 0 auto;\r\n}\r\n\r\n.link-card {\r\n  margin-top: 5px;\r\n  margin-bottom: 0;\r\n  height: 10px;\r\n  text-align: center;\r\n}\r\n\r\n.title {\r\n  margin-left: 10px;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  white-space: nowrap;\r\n}\r\n\r\na {\r\n  color: rgb(78, 78, 78);\r\n  text-decoration: none !important;\r\n  background-color: transparent;\r\n}\r\n\r\n.footer-card {\r\n  width: 298px;\r\n}\r\n\r\n.swiper-container {\r\n  width: 100%;\r\n  height: 100%;\r\n  padding: 0 12px 12px;\r\n  min-height: 445px;\r\n}\r\n\r\n.swiper-container {\r\n  margin-left: auto;\r\n  margin-right: auto;\r\n  position: relative;\r\n  overflow: hidden;\r\n  list-style: none;\r\n  padding: 0;\r\n  z-index: 1;\r\n}\r\n\r\n.swiper-container-horizontal > .swiper-scrollbar {\r\n  display: none;\r\n}\r\n\r\n.swiper-scrollbar {\r\n  margin-top: 20px !important;\r\n}\r\n\r\n.poster {\r\n  -o-object-fit: cover;\r\n  object-fit: cover;\r\n  height: 445px;\r\n  background-size: cover;\r\n}\r\n\r\n.card-img-top {\r\n  border-top-left-radius: calc(0.25rem - 1px);\r\n  border-top-right-radius: calc(0.25rem - 1px);\r\n}\r\n\r\n.card {\r\n  border: 3px solid rgba(145, 145, 145, 0.3);\r\n  height: 70%;\r\n  width: 300px;\r\n}\r\n\r\n.swiper-wrapper {\r\n  position: relative;\r\n  width: 100%;\r\n  height: 100%;\r\n  z-index: 1;\r\n  display: flex;\r\n  transition-property: transform;\r\n  box-sizing: content-box;\r\n}\r\n\r\n.swiper-container .swiper-notification {\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0;\r\n  pointer-events: none;\r\n  opacity: 0;\r\n  z-index: -100;\r\n}\r\n\r\n.swiper-btn {\r\n  position: absolute;\r\n  width: 70px;\r\n  height: 100%;\r\n  border-radius: 5px;\r\n  top: 0;\r\n  background-repeat: no-repeat;\r\n  background-position: 50%;\r\n  cursor: pointer;\r\n  outline: none;\r\n  -webkit-transition: 0.5s;\r\n  transition: 0.5s;\r\n}\r\n\r\n.select-wraper {\r\n  display: flex;\r\n  justify-content: flex-end;\r\n  max-width: 1440px;\r\n  padding-right: 60px;\r\n}\r\n#selectElementId {\r\n    border: 3px solid  rgba(62, 134, 163, 1); \r\n    border-radius: 5px;\r\n    overflow: hidden; \r\n    height: 40px;\r\n    width: 85px;\r\n    font-family: \"Poppins\", sans-serif;\r\n    font-size: 15px;\r\n    color: rgb(145, 145, 145);\r\n}\r\noption{\r\n    font-family: \"Poppins\", sans-serif;\r\n  font-size: 15px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;;EAEE,yCAAyC;EACzC,kBAAkB;EAClB,gBAAgB;EAChB,8CAA8C;AAChD;AACA;EACE,2CAA2C;EAC3C,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,sBAAsB;EACtB,cAAc;AAChB;;AAEA;EACE,iBAAiB;EACjB,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,cAAc;EACd,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,oBAAoB;EACpB,kCAAkC;EAClC,oBAAoB;EACpB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,mBAAmB;EACnB,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,UAAU;AACZ;;AAEA;;EAEE,kBAAkB;EAClB,UAAU;EACV,YAAY;EACZ,YAAY;EACZ,UAAU;EACV,sBAAsB;AACxB;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;EACnB,gBAAgB;AAClB;;AAEA;EACE,oBAAoB;EACpB,aAAa;EACb,yBAAyB;EACzB,8BAA8B;EAC9B,yBAAyB;EACzB,mBAAmB;EACnB,eAAe;EACf,eAAe;AACjB;AACA;EACE,gBAAgB;EAChB,gCAAgC;AAClC;AACA;EACE,cAAc;EACd,yBAAyB;EACzB,iBAAiB;EACjB,oBAAoB;AACtB;AACA;EACE,kCAAkC;EAClC,eAAe;EACf,yBAAyB;AAC3B;AACA;EACE,kCAAkC;EAClC,eAAe;EACf,yBAAyB;AAC3B;;AAEA;;EAEE,iBAAiB;AACnB;;AAEA;;;;;EAKE,SAAS;EACT,oBAAoB;EACpB,kBAAkB;EAClB,oBAAoB;AACtB;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,kCAAkC;EAClC,uCAAuC;EACvC,WAAW;EACX,aAAa;EACb,eAAe;AACjB;;AAEA;EACE,qBAAqB;EACrB,WAAW;EACX,YAAY;EACZ,2BAA2B;EAC3B,oBAAoB;EACpB,sCAAsC;EACtC,kBAAkB;EAClB,uDAAuD;EACvD,+CAA+C;AACjD;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,kBAAkB;EAClB,YAAY;AACd;;AAEA;;EAEE,oBAAoB;EACpB,wBAAwB;AAC1B;;AAEA;EACE,oBAAoB;EACpB,cAAc;EACd,gBAAgB;EAChB,wBAAwB;EACxB,kBAAkB;EAClB,kBAAkB;EAClB,mBAAmB;EACnB,gBAAgB;EAChB,uBAAuB;EACvB,eAAe;EACf,YAAY;EACZ,kCAAkC;EAClC,oBAAoB;EACpB,oCAAoC;AACtC;;AAEA;EACE;IACE,cAAc;EAChB;AACF;;AAEA;EACE;;;;IAIE,aAAa;EACf;EACA;IACE,uBAAuB;IACvB,mBAAmB;EACrB;EACA;IACE,kBAAkB;IAClB,mBAAmB;IACnB,UAAU;EACZ;EACA;IACE,kBAAkB;EACpB;EACA;IACE,QAAQ;IACR,WAAW;EACb;AACF;;AAEA;EACE,iCAAiC;EACjC,yBAAyB;EACzB,aAAa;AACf;;AAEA;EACE,qBAAqB;EACrB,6BAA6B;AAC/B;;AAEA;EACE,eAAe;EACf,kBAAkB;EAClB,WAAW;EACX,YAAY;AACd;;AAEA;;;;EAIE,eAAe;EACf,kBAAkB;EAClB,SAAS;EACT,gBAAgB;EAChB,kBAAkB;EAClB,yBAAyB;AAC3B;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,UAAU;EACV,WAAW;AACb;;AAEA;EACE,UAAU;EACV,WAAW;AACb;;AAEA;EACE,mDAAmD;AACrD;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,WAAW;EACX,UAAU;AACZ;;AAEA;;;EAGE,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,cAAc;AAChB;;AAEA;EACE,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,sBAAsB;EACtB,gCAAgC;EAChC,6BAA6B;AAC/B;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,oBAAoB;EACpB,iBAAiB;AACnB;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;EAClB,kBAAkB;EAClB,gBAAgB;EAChB,gBAAgB;EAChB,UAAU;EACV,UAAU;AACZ;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,oBAAoB;EACpB,iBAAiB;EACjB,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,2CAA2C;EAC3C,4CAA4C;AAC9C;;AAEA;EACE,0CAA0C;EAC1C,WAAW;EACX,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,UAAU;EACV,aAAa;EACb,8BAA8B;EAC9B,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,OAAO;EACP,MAAM;EACN,oBAAoB;EACpB,UAAU;EACV,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,MAAM;EACN,4BAA4B;EAC5B,wBAAwB;EACxB,eAAe;EACf,aAAa;EACb,wBAAwB;EACxB,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,yBAAyB;EACzB,iBAAiB;EACjB,mBAAmB;AACrB;AACA;IACI,wCAAwC;IACxC,kBAAkB;IAClB,gBAAgB;IAChB,YAAY;IACZ,WAAW;IACX,kCAAkC;IAClC,eAAe;IACf,yBAAyB;AAC7B;AACA;IACI,kCAAkC;EACpC,eAAe;EACf,yBAAyB;AAC3B","sourcesContent":["footer,\r\nheader {\r\n  background-color: rgba(62, 134, 163, 0.6);\r\n  text-align: center;\r\n  min-height: 10vh;\r\n  border-bottom: 3px solid rgba(62, 134, 163, 1);\r\n}\r\nfooter {\r\n  border-top: 3px solid rgba(62, 134, 163, 1);\r\n  display: flex;\r\n  align-items: center;\r\n}\r\n\r\n* {\r\n  box-sizing: border-box;\r\n  margin: 0 auto;\r\n}\r\n\r\n.wrapper-form {\r\n  max-width: 1440px;\r\n  margin-left: 50px;\r\n}\r\n\r\n.wrapper-slider {\r\n  max-width: 1440px;\r\n  margin: 0 auto;\r\n  margin-top: 50px;\r\n  margin-bottom: 50px;\r\n}\r\n\r\n.logo {\r\n  font-size: 2rem;\r\n}\r\n\r\n.navbar-brand {\r\n  display: inline-flex;\r\n  font-family: \"Poppins\", sans-serif;\r\n  line-height: inherit;\r\n  padding: 30px;\r\n  white-space: nowrap;\r\n}\r\n\r\n.nav-bar__logo__img {\r\n  width: 60px;\r\n  margin-bottom: 15px;\r\n  margin-left: -30px;\r\n  height: 60px;\r\n}\r\n\r\nh1.text-info {\r\n  color: #fff !important;\r\n}\r\n\r\n.close {\r\n  position: relative;\r\n  right: 130px;\r\n  bottom: 15px;\r\n}\r\n\r\n.close:hover {\r\n  opacity: 1;\r\n}\r\n\r\n.close:before,\r\n.close:after {\r\n  position: absolute;\r\n  left: 15px;\r\n  content: \" \";\r\n  height: 33px;\r\n  width: 2px;\r\n  background-color: #333;\r\n}\r\n\r\n.close:before {\r\n  transform: rotate(45deg);\r\n}\r\n\r\n.close:after {\r\n  transform: rotate(-45deg);\r\n}\r\n\r\n.form-group {\r\n  position: relative;\r\n  margin-bottom: 10px;\r\n  margin-top: 10px;\r\n}\r\n\r\n.form-row {\r\n  display: -webkit-box;\r\n  display: flex;\r\n  -webkit-box-pack: justify;\r\n  justify-content: space-between;\r\n  -webkit-box-align: center;\r\n  align-items: center;\r\n  flex-wrap: wrap;\r\n  margin-right: 0;\r\n}\r\n.form-control:focus {\r\n  box-shadow: none;\r\n  border-color: rgb(145, 145, 145);\r\n}\r\n.search-input {\r\n  display: block;\r\n  width: calc(100% - 150px);\r\n  max-width: 1350px;\r\n  padding-right: 100px;\r\n}\r\ninput[type=\"text\"] {\r\n  font-family: \"Poppins\", sans-serif;\r\n  font-size: 17px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n.search-input::placeholder {\r\n  font-family: \"Poppins\", sans-serif;\r\n  font-size: 17px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n\r\nbutton,\r\ninput {\r\n  overflow: visible;\r\n}\r\n\r\nbutton,\r\ninput,\r\noptgroup,\r\nselect,\r\ntextarea {\r\n  margin: 0;\r\n  font-family: inherit;\r\n  font-size: inherit;\r\n  line-height: inherit;\r\n}\r\n\r\n#submit-bottom {\r\n  position: absolute;\r\n  right: 60px;\r\n  font-family: \"Poppins\", sans-serif;\r\n  background-color: rgba(62, 134, 163, 1);\r\n  color: #fff;\r\n  padding: 10px;\r\n  font-size: 17px;\r\n}\r\n\r\n.spinner-border {\r\n  display: inline-block;\r\n  width: 2rem;\r\n  height: 2rem;\r\n  vertical-align: text-bottom;\r\n  border: 0.25em solid;\r\n  border-right: 0.25em solid transparent;\r\n  border-radius: 50%;\r\n  -webkit-animation: spinner-border 0.75s linear infinite;\r\n  animation: spinner-border 0.75s linear infinite;\r\n}\r\n\r\n.d-none {\r\n  display: none !important;\r\n}\r\n\r\n.spinner-border {\r\n  position: absolute;\r\n  right: 240px;\r\n}\r\n\r\nbutton,\r\nselect {\r\n  text-transform: none;\r\n  outline: none !important;\r\n}\r\n\r\n.info {\r\n  padding-bottom: 50px;\r\n  margin: 0 auto;\r\n  max-width: 340px;\r\n  /* margin-left: -50px; */\r\n  text-align: center;\r\n  padding-left: 20px;\r\n  padding-right: 20px;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  font-size: 1rem;\r\n  height: 2rem;\r\n  font-family: \"Poppins\", sans-serif;\r\n  line-height: inherit;\r\n  color: rgb(145, 145, 145) !important;\r\n}\r\n\r\n@media (min-width: 1441px) {\r\n  .wrapper-form {\r\n    margin: 0 auto;\r\n  }\r\n}\r\n\r\n@media (max-width: 576px) {\r\n  #submit-bottom,\r\n  .clear-input-btn,\r\n  .nav-bar__logo__img,\r\n  .wrapper {\r\n    display: none;\r\n  }\r\n  .form-row {\r\n    justify-content: center;\r\n    padding-right: 10px;\r\n  }\r\n  .search-input {\r\n    padding-left: 50px;\r\n    padding-right: 20px;\r\n    width: 95%;\r\n  }\r\n  .speak-btn {\r\n    margin-top: 0.5rem;\r\n  }\r\n  .spinner-border {\r\n    top: 5px;\r\n    right: 40px;\r\n  }\r\n}\r\n\r\na.footer-link {\r\n  -webkit-transition-duration: 0.5s;\r\n  transition-duration: 0.5s;\r\n  display: flex;\r\n}\r\n\r\na {\r\n  text-decoration: none;\r\n  background-color: transparent;\r\n}\r\n\r\n.github-logo {\r\n  margin-top: 5px;\r\n  margin-right: -7px;\r\n  width: 20px;\r\n  height: 20px;\r\n}\r\n\r\nh5,\r\n.github,\r\n.year,\r\n.MDb {\r\n  font-size: 1rem;\r\n  position: relative;\r\n  margin: 0;\r\n  padding-top: 5px;\r\n  padding-left: 10px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n\r\n.title:hover {\r\n  color: rgb(195, 240, 247) !important;\r\n}\r\n\r\n.MDb {\r\n  left: 80px;\r\n  bottom: 3px;\r\n}\r\n\r\n.year {\r\n  left: 35px;\r\n  bottom: 3px;\r\n}\r\n\r\n:root {\r\n  --swiper-theme-color: rgb(145, 145, 145) !important;\r\n}\r\n\r\n.film-star {\r\n  position: relative;\r\n  width: 20px;\r\n  height: 20px;\r\n  bottom: 5px;\r\n  left: 90px;\r\n}\r\n\r\n.film-rating,\r\n.year,\r\n.title {\r\n  font-size: 20px;\r\n  font-weight: 650;\r\n}\r\n\r\n.text-muted {\r\n  color: #fff !important;\r\n}\r\n\r\n.slider {\r\n  position: relative;\r\n  max-width: 1440px;\r\n  margin: 0 auto;\r\n}\r\n\r\n.link-card {\r\n  margin-top: 5px;\r\n  margin-bottom: 0;\r\n  height: 10px;\r\n  text-align: center;\r\n}\r\n\r\n.title {\r\n  margin-left: 10px;\r\n  overflow: hidden;\r\n  text-overflow: ellipsis;\r\n  white-space: nowrap;\r\n}\r\n\r\na {\r\n  color: rgb(78, 78, 78);\r\n  text-decoration: none !important;\r\n  background-color: transparent;\r\n}\r\n\r\n.footer-card {\r\n  width: 298px;\r\n}\r\n\r\n.swiper-container {\r\n  width: 100%;\r\n  height: 100%;\r\n  padding: 0 12px 12px;\r\n  min-height: 445px;\r\n}\r\n\r\n.swiper-container {\r\n  margin-left: auto;\r\n  margin-right: auto;\r\n  position: relative;\r\n  overflow: hidden;\r\n  list-style: none;\r\n  padding: 0;\r\n  z-index: 1;\r\n}\r\n\r\n.swiper-container-horizontal > .swiper-scrollbar {\r\n  display: none;\r\n}\r\n\r\n.swiper-scrollbar {\r\n  margin-top: 20px !important;\r\n}\r\n\r\n.poster {\r\n  -o-object-fit: cover;\r\n  object-fit: cover;\r\n  height: 445px;\r\n  background-size: cover;\r\n}\r\n\r\n.card-img-top {\r\n  border-top-left-radius: calc(0.25rem - 1px);\r\n  border-top-right-radius: calc(0.25rem - 1px);\r\n}\r\n\r\n.card {\r\n  border: 3px solid rgba(145, 145, 145, 0.3);\r\n  height: 70%;\r\n  width: 300px;\r\n}\r\n\r\n.swiper-wrapper {\r\n  position: relative;\r\n  width: 100%;\r\n  height: 100%;\r\n  z-index: 1;\r\n  display: flex;\r\n  transition-property: transform;\r\n  box-sizing: content-box;\r\n}\r\n\r\n.swiper-container .swiper-notification {\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0;\r\n  pointer-events: none;\r\n  opacity: 0;\r\n  z-index: -100;\r\n}\r\n\r\n.swiper-btn {\r\n  position: absolute;\r\n  width: 70px;\r\n  height: 100%;\r\n  border-radius: 5px;\r\n  top: 0;\r\n  background-repeat: no-repeat;\r\n  background-position: 50%;\r\n  cursor: pointer;\r\n  outline: none;\r\n  -webkit-transition: 0.5s;\r\n  transition: 0.5s;\r\n}\r\n\r\n.select-wraper {\r\n  display: flex;\r\n  justify-content: flex-end;\r\n  max-width: 1440px;\r\n  padding-right: 60px;\r\n}\r\n#selectElementId {\r\n    border: 3px solid  rgba(62, 134, 163, 1); \r\n    border-radius: 5px;\r\n    overflow: hidden; \r\n    height: 40px;\r\n    width: 85px;\r\n    font-family: \"Poppins\", sans-serif;\r\n    font-size: 15px;\r\n    color: rgb(145, 145, 145);\r\n}\r\noption{\r\n    font-family: \"Poppins\", sans-serif;\r\n  font-size: 15px;\r\n  color: rgb(145, 145, 145);\r\n}\r\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_swiper_bundle_css__WEBPACK_IMPORTED_MODULE_1__.default.locals || {});
